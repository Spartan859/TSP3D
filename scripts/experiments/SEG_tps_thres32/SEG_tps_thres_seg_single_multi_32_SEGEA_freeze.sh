# 相对SEG_tps_thres_seg_single_multi_32_SEGEA_reduce_lr，从scripts/experiments/SEG_tps_thres32/SEG_tps_thres_seg_single_multi_32_SEGEA_resume2/scanrefer/2026-05-16_11-31-32/ckpt_epoch_300.pth继续训练（不加载scheduler, optimizer），冻结所有模块的权重，只训练seg部分，看看能不能提升性能
...
BASE_LR=0
BASE_KEEP_TRANS_LR=0
BASE_TEXT_ENCODER_LR=0
BASE_BOX_SELECT_LR=0
BASE_SEG_LR=1e-4
# ------------------------
RNG_SEED=42
...
TORCH_DISTRIBUTED_DEBUG=INFO CUDA_VISIBLE_DEVICES=${cvd} "${dist_launch_cmd[@]}" \
    ...
    --use_refine \
    --use_seg \
    --checkpoint_path ${PWD}/scripts/experiments/SEG_tps_thres32/SEG_tps_thres_seg_single_multi_32_SEGEA_resume2/scanrefer/2026-05-16_11-31-32/ckpt_epoch_300.pth \
