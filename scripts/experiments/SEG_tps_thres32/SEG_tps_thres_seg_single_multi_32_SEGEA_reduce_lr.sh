# 相对SEG_tps_thres_seg_single_multi_32_SEGEA_resume2，添加一次lr decay，从scripts/experiments/SEG_tps_thres32/SEG_tps_thres_seg_single_multi_32_SEGEA_resume2/scanrefer/2026-05-16_11-31-32/ckpt_epoch_300.pth继续训练，不使用top_pts_threshold 32，看看能不能提升性能
