# WildRefer voxel baseline with two temporal point-cloud frames fused before voxelization.
...
export WILDREFER_FRAME_NUM="${WILDREFER_FRAME_NUM:-2}"
export WILDREFER_FUSE_FRAMES="${WILDREFER_FUSE_FRAMES:-1}"
