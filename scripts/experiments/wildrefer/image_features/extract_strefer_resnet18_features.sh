# Extract STRefer image feature maps consumed by wildrefer_EA0_resnet18img_prune035_400e.sh.
...
OUTPUT="${OUTPUT:-${PWD}/data/WildRefer/strefer_resnet18_layer3_448.h5}"
DEVICE="${DEVICE:-cuda}"
