# Resume the best ResNet18 image-feature STRefer checkpoint and let ReduceLROnPlateau lower LR.
...
export EXP_NAME="${EXP_NAME:-wildrefer_EA0_resnet18img_resume156_plateau_baseLR_260e_${WILDREFER_DATASET:-strefer}}"
