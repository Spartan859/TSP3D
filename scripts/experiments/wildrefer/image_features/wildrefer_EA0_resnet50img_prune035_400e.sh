# WildRefer EA0 with projected ResNet50 image feature maps appended to voxel input.
...
export WILDREFER_IMAGE_FEATURE_PATH="${WILDREFER_IMAGE_FEATURE_PATH:-${PWD}/data/WildRefer/strefer_resnet50_layer3_448.h5}"
export WILDREFER_IMAGE_FEATURE_DIM="${WILDREFER_IMAGE_FEATURE_DIM:-1024}"
